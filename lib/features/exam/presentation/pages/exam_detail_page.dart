      ...
      showDialog(
        ...
        builder: (ctx) => AlertDialog(
          ...
          title: Row(
            children: [
              Icon(
                unanswered > 0 ? Icons.warning_amber_rounded : Icons.check_circle_outline,
                color: unanswered > 0 ? Colors.orange : Colors.green,
                size: 28,
              ),
          ...
          content: Text(
            unanswered > 0
                ...
                : "Bạn đã hoàn thành tất cả các câu hỏi.\nBạn có muốn nộp bài và xem kết quả ngay?",
            style: const TextStyle(fontSize: 16, height: 1.4),
          ),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(ctx),
              child: const Text("Xem lại", style: TextStyle(color: Colors.grey, fontSize: 15)),
            ),
            ElevatedButton(
              onPressed: () {
                Navigator.pop(ctx);
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: unanswered > 0 ? Colors.orange : Colors.blue,
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
              ),
              child: Text(
                unanswered > 0 ? "Nộp bài luôn" : "Nộp bài",
            ...
            body: BlocConsumer<ExamDetailBloc, ExamDetailState>(
                ...
                if (state is ExamSubmissionSuccess) {
                  ...
                  if (state.timeLeft <= 0) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text("Hết giờ làm bài! Hệ thống đang tự động nộp bài..."),
              ...
              builder: (context, state) {
                ...
                if (state is ExamDetailLoading) {
                  ...
                  for (int i = 0; i < state.examDetail.questions.length; i++) {
                    if (state.userAnswers.containsKey(
                      state.examDetail.questions[i].id,
                    )) {
                    ...
                    child: Column(
                      children: [
                        ...
                        ExamFooter(
                          ...
                          totalQuestions: state.examDetail.questions.length,
